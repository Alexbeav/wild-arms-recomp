...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Wild Arms",
    .project_root_env = "WILD_ARMS_PROJECT_ROOT",
    .build_dir_env = "WILD_ARMS_BUILD_DIR",
    .force_setup_env = "WILD_ARMS_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCUS_946.08_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Wild_Arms",
    .prepare_note =
